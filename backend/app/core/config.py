...
# 만료 인스턴스 정리 주기 (기본: 3분)
CHALLENGE_INSTANCE_CLEANUP_INTERVAL_SECONDS = int(
    os.getenv("CHALLENGE_INSTANCE_CLEANUP_INTERVAL_SECONDS", "180")
)
if CHALLENGE_INSTANCE_CLEANUP_INTERVAL_SECONDS < 1:
    CHALLENGE_INSTANCE_CLEANUP_INTERVAL_SECONDS = 180
